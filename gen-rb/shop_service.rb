...
module Line
  module ShopService
    ...
    class BuyCoinProduct_args
      ...
      FIELDS = {
        PAYMENTRESERVATION => {:type => ::Thrift::Types::STRUCT, :name => 'paymentReservation', :class => ::Line::PaymentReservation}
      }
    ...
    class GetActivePurchases_result
      ...
      FIELDS = {
        SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Line::ProductList},
        E => {:type => ::Thrift::Types::STRUCT, :name => 'e', :class => ::Line::TalkException}
      }
    ...
    class GetActivePurchaseVersions_result
      ...
      FIELDS = {
        SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Line::ProductSimpleList},
        E => {:type => ::Thrift::Types::STRUCT, :name => 'e', :class => ::Line::TalkException}
      }
    ...
    class GetCoinProducts_result
      ...
      FIELDS = {
        SUCCESS => {:type => ::Thrift::Types::LIST, :name => 'success', :element => {:type => ::Thrift::Types::STRUCT, :class => ::Line::CoinProductItem}},
        E => {:type => ::Thrift::Types::STRUCT, :name => 'e', :class => ::Line::TalkException}
      }
    ...
    class GetCoinPurchaseHistory_args
      ...
      FIELDS = {
        REQUEST => {:type => ::Thrift::Types::STRUCT, :name => 'request', :class => ::Line::CoinHistoryCondition}
      }
    ...
    class GetCoinPurchaseHistory_result
      ...
      FIELDS = {
        SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Line::CoinHistoryResult},
        E => {:type => ::Thrift::Types::STRUCT, :name => 'e', :class => ::Line::TalkException}
      }
    ...
    class GetProduct_result
      ...
      FIELDS = {
        SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Line::Product},
        E => {:type => ::Thrift::Types::STRUCT, :name => 'e', :class => ::Line::TalkException}
      }
    ...
    class GetTotalBalance_result
      ...
      FIELDS = {
        SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Line::Coin},
        E => {:type => ::Thrift::Types::STRUCT, :name => 'e', :class => ::Line::TalkException}
      }
    ...
    class ReserveCoinPurchase_args
      ...
      FIELDS = {
        REQUEST => {:type => ::Thrift::Types::STRUCT, :name => 'request', :class => ::Line::CoinPurchaseReservation}
      }
    ...
    class ReserveCoinPurchase_result
      ...
      FIELDS = {
        SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::Line::PaymentReservationResult},
        E => {:type => ::Thrift::Types::STRUCT, :name => 'e', :class => ::Line::TalkException}
      }
